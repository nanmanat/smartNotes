...
function ModeSelector({ selectedMode, setSelectedMode }) {
  ...
  const modes = [
    ...
    { 
      id: 'classroom', 
      label: 'Classroom', 
      description: 'For lectures and classes',
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    { 
      id: 'meeting', 
      label: 'Meeting', 
      description: 'For work meetings and discussions',
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    <div className="relative mb-6" ref={dropdownRef}>
      ...
      >
        <div className="flex items-center">
          ...
          <div>
            <div className="font-medium text-slate-900 dark:text-white">{currentMode ? currentMode.label : 'Select Mode'}</div>
      ...
      `}>
        <div className="p-4 border-b border-slate-200 dark:border-slate-700">
          <h3 className="text-lg font-semibold text-slate-900 dark:text-white">Select Mode</h3>
          <p className="text-sm text-slate-500 dark:text-slate-400">Choose how you want to use Smart Notes</p>
        </div>
        <div className="p-2">
          {modes.map((mode) => {
